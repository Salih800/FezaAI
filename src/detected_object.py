class DetectedObject:
    ...
    def __str__(self):
        return f"class: {self.cls}, landing_status: {self.landing_status}, top_left_x: {self.top_left_x}," \
               f" top_left_y: {self.top_left_y}, bottom_right_x: {self.bottom_right_x}, bottom_right_y: {self.bottom_right_y}"
